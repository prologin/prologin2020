...
\def\ptitle{\textsc{Des baffes fleuries}} %% Subject's main title
\def\psubtitle{Tout est dans l'élégance} %% Subject's sub title

\def\plogo{logo2020.pdf} %% Logo FIXME
\def\psubjectpicture{logo.jpg} %% Picture to be displayed FIXME
